...
public class SearchVideoUtil
{
	...
	public static String parseJson(int page) throws Exception
	{
		...
		// 设置请求的参数
		StringEntity params = new StringEntity("{\"currentPage\":"+page+", \"pageSize\":8, \"status\":0, \"type\":0}",
				Consts.UTF_8);
	...
	public static String parseMobileJson(int page) throws Exception
	{
		DefaultHttpClient httpClient = new DefaultHttpClient();
		String url = "https://vcloud.163.com/app/vod/video/list";
		HttpPost httpPost = new HttpPost(url);
		...
		// 设置请求的参数
		StringEntity params = new StringEntity("{\"currentPage\":"+page+", \"pageSize\":5, \"status\":0, \"type\":0}",
				Consts.UTF_8);
		httpPost.setEntity(params);
